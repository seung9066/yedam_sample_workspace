...
document.write('<br><div style="border: 1px solid black; padding: 10px"><p><span><</span>function 달력<span>></span></p>')
...
let cal1 = '<table border=1 style="text-align: center;">';
cal1 += '<tr><th style="color: red;">일</th><th>월</th><th>화</th><th>수</th><th>목</th><th>금</th><th>토</th>';
cal1 += '<tr>'
let month = 12;
