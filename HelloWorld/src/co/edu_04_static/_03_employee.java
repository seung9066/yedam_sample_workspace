...
public class _03_employee {
	...
	public _03_employee() { // 기본 생성자
	}

	public _03_employee(int employeeId, String name, int salary, int departmentId) { // 생성자 오버로딩
	...
	public _03_employee(int employeeId, String name) { // 사번, 이름 초기화
		this(employeeId, name, 100, 30); // this : 다른 생성자 호출 시에도 사용 가능
	}

	public _03_employee(int employeeId, String name, int salary) { // 사번, 이름, 급여 초기화
