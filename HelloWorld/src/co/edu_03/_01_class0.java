...
public class _01_class0 {
	public static void main(String[] args) {
		
		_01_class0student s1 = new _01_class0student(); // new를 통해 초기화를 시켜줘야한다.
		s1.name = "최승현";
		s1.age = 19;
		s1.score = 80;
		s1.height = 180.1;

		_01_class0student s2 = new _01_class0student();
		s2.name = "박민수";
		s2.age = 20;
		s2.score = 85;
		s2.height = 178.2;

		_01_class0student s3 = new _01_class0student();
		s3.name = "박춘배";
		s3.age = 21;
		s3.score = 79;
		s3.height = 168.9;

		_01_class0student[] students = { s1, s2, s3 };
