...
public class _01_main {
	...
	public static void main(String[] args) {
		...
		_01_cellphone dphone = new _01_dmbcellphone(); // 자식을 부모에 담을 수 있음(부모 <= 자식)
		dphone.powerOn();
		// dphone.dmbon(); dphone은 dmb지만 부모(cellphone)로 담겨있는데 dmbon은 부모가 가진 기능이 아니기에 사용 불가
		...
		// _01_dmbcellphone dcp1 = (_01_dmbcellphone) cphone; // 부모를 자식으로 바꾸는게 불가능해서 출력시 error발생(큰거에서 작은거로는 형변환 x)
