package co.edu_06_interfaces_employee;

import java.util.Calendar;
import java.util.Scanner;

import co.edu_06_interfaces.employee.Employee;
...
public class Employeelist {
	...
	public void input() {
		...
		list[empnum++] = new Employee(no, name, sal); // 사원 인스턴스 생성 -> 배열 저장 / new를 통해 empnum이 0 -> 1
	}
